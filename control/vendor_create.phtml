...
?>
          ...
          <div class="col-xs-12 col-md-9">
            ...
            <section id="page-header">
              ...
              <h1><span class="glyphicon glyphicon-shopping-cart"></span> Vendors :: Add New</h1>
              </section>
...
<?php 
	...
	$vendor_id = insertRecord('vendors');
